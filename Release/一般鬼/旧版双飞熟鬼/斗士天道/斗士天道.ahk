        ...
        if (ele == 2){
            ...
            3loopTimer :=1
             loop{
                ...
                ControlSend, ,{2}, ahk_id %ahId%
                ControlSend, ,{z}, ahk_id %ahId%
                ControlSend, ,{c}, ahk_id %ahId%
        ...
        if ( ele == 3){
            loop{
                ...
                if (GetColor(1030,921,"0xB8A379",1)){ 
                    ...
                    if (GetColor(1032,978,"0x58B0D9",1)){
                    ; v
                        send v
                        sleep 20
                    }
...
Gohall(e){
    if (e == 1){
        ...
        }until (GetColor(892,929,"0xFBF5FC",1)) 
        sleep 500
        send {w down}
        sleep 5000
        loop{
...
plaf(){
    ...
    loop{
        if ( runsLoop == 1 ){
            ...
            loop{
                sleep 1000
            }until (GetColor(894,991,"0x9C3219",1))
        }
        sleep 3000
        send,{w up}
        sleep 500
